...
-**Sidebar** com categorias (Dorama, Terror, Animes)

-**Conteúdo principal** com Grid de cards de filmes
...
assets/
├── css/
│   ├── style.css       # Estilos principais (CSS Grid, cards, cores)
│   └── response.css    # Media queries para mobile
...
- Cards de filmes com hover animado

- Menu de navegação com âncoras para a sessão
